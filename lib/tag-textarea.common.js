...
function () {
  ...
  _createClass(_default, [{
    ...
    value: function print(PAWindow) {
      ...
      var _loaded = function _loaded() {
        ...
        try {
          ...
          var canvasList = _this.elsdom.querySelectorAll('.canvasImg'); // console.log(this.elsdom)
          ...
          if (_this.settings.endCallback !== null) {
            _this.settings.endCallback();
          }
        } catch (e) {
          console.log(e);
        }
    ...
    value: function getHead() {
      ...
      var modeStyle = '<style>@page {size: portrait }</style>';
